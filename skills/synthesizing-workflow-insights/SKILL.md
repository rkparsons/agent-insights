...
5. Every path anywhere in the file is `~`-relative — no `/Users/…`, `/home/…` or `$HOME/…` in any target, source path, statement, asset content, rationale, title, or dropped summary/reason.
